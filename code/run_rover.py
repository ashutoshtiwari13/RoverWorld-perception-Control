...
from utils import update_rover, create_output_images

# Initialize socketio server and Flask application
sio = socketio.Server()
app = Flask(__name__)

# Images are read in by default with the origin (0, 0) in the upper left
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Rover Driving')
    parser.add_argument(
        'image_folder',
        type=str,
        nargs='?',
